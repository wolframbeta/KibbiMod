...
public class FireKibbiEntityModel<Type extends FireKibbiEntity> extends EntityModel<Type> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(KibbiMod.MODID, "fire_kibbi"), "main");
	...
	public FireKibbiEntityModel(ModelPart root) {
	...
	@Override
	public void setupAnim(FireKibbiEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
