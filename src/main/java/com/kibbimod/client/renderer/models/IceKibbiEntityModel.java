...
public class IceKibbiEntityModel<Type extends IceKibbiEntity> extends EntityModel<Type> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(KibbiMod.MODID, "ice_kibbi"), "main");
	...
	public IceKibbiEntityModel(ModelPart root) {
	...
	@Override
	public void setupAnim(IceKibbiEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
